        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>NextLevel<small>All Order List</small></h2>
                                                ...
                                                @foreach ($orders as $order)
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <span style="font-size: 14px" class="{{ $order->status == 'success' ? 'badge bg-primary text-light' : 'badge bg-warning text-dark' }}">{{ $order->status }}</span>
                                                        </td>
