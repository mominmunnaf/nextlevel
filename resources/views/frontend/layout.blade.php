    ...
    <div class="banner_bg_main">
        ...
        <div class="container">
            <div class="header_section_top">
                <div class="row">
                    <div class="col-sm-12">
                        <a href="{{ route('admin_login_form') }}" class="btn btn-sm btn-outline-danger text-light float-right mr-5">Admin</a>
                        ...
                        <div class="logo"><a href="index.html"><img src="{{ asset('frontend') }}/images/logo.png"></a>
                            <div class="float-right">
                                <a href="{{ route('user_login_form') }}"
                                    class="btn btn-sm btn-outline-danger text-light">Login</a>
                                <a href="{{ route('user_register_process') }}"
                                    class="btn btn-sm btn-outline-danger text-light">Register</a>
                                <a href="{{ route('logout') }}"
                                    class="btn btn-sm btn-outline-danger text-light">Logout</a>
